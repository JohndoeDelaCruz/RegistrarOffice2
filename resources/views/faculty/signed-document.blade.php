        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-6 mb-8">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <span class="text-gray-800 ml-2">{{ $application->created_at->format('F j, Y') }} at {{ $application->created_at->format('g:i A') }}</span>
                </div>
                <div>
        ...
        <div class="bg-green-50 border border-green-200 rounded-lg p-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <span class="text-gray-800 ml-2">{{ $application->dean_reviewed_at->format('F j, Y') }} at {{ $application->dean_reviewed_at->format('g:i A') }}</span>
                </div>
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <span class="text-gray-800 ml-2">{{ $application->faculty_processed_at ? $application->faculty_processed_at->format('F j, Y') . ' at ' . $application->faculty_processed_at->format('g:i A') : 'N/A' }}</span>
                </div>
