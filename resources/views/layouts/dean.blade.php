...
<body class="bg-uc-bg">
    <div class="flex h-screen">
        <!-- Sidebar -->
        <div class="bg-gradient-to-b from-uc-green to-uc-green-dark text-white w-64 flex-shrink-0 shadow-xl">
            <!-- Header -->
            ...
            <nav class="mt-6">
                ...
                <a href="{{ route('dean.dashboard') }}" class="flex items-center px-6 py-3 text-white hover:bg-green-600 transition-colors duration-200 {{ request()->routeIs('dean.dashboard') ? 'bg-green-600 border-r-4 border-green-300' : '' }}">
                    <i class="fas fa-tachometer-alt w-5 h-5 mr-3"></i>
                    <span>Dashboard</span>
                </a>

                <a href="{{ route('dean.grade-completion-applications') }}" class="flex items-center px-6 py-3 text-white hover:bg-green-600 transition-colors duration-200 {{ request()->routeIs('dean.grade-completion-applications') ? 'bg-green-600 border-r-4 border-green-300' : '' }}">
                    <i class="fas fa-file-alt w-5 h-5 mr-3"></i>
                    <span>Grade Completion Applications</span>
                </a>

                <a href="{{ route('dean.approved-applications') }}" class="flex items-center px-6 py-3 text-white hover:bg-green-600 transition-colors duration-200 {{ request()->routeIs('dean.approved-applications') ? 'bg-green-600 border-r-4 border-green-300' : '' }}">
                    <i class="fas fa-check-circle w-5 h-5 mr-3"></i>
                    <span>Approved Applications</span>
                </a>

                <a href="{{ route('dean.announcement') }}" class="flex items-center px-6 py-3 text-white hover:bg-green-600 transition-colors duration-200 {{ request()->routeIs('dean.announcement') ? 'bg-green-600 border-r-4 border-green-300' : '' }}">
                    <i class="fas fa-bullhorn w-5 h-5 mr-3"></i>
                    <span>Announcements</span>
                </a>

                <a href="{{ route('dean.profile') }}" class="flex items-center px-6 py-3 text-white hover:bg-green-600 transition-colors duration-200 {{ request()->routeIs('dean.profile') ? 'bg-green-600 border-r-4 border-green-300' : '' }}">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="relative">
                            <button onclick="toggleDropdown()" class="flex items-center space-x-2 text-gray-700 hover:text-gray-900">
                                <div class="w-8 h-8 bg-gradient-to-br from-uc-green to-uc-green-dark rounded-full flex items-center justify-center">
